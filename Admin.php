                ...
                <div id="imaginary_container">
                  <form action="Admin.php" method="POST">
                    <div class="input-group stylish-input-group">
                        <input type="text" class="form-control" name="URLinput"  placeholder="https://www.Name.com/">
                    </div>
                    <br />

                    <button type="submit" name="URLSearchBTN" id="GoogleSearchBTN">
